...
<div class="w-4/5 m-auto text-left">
    <div class="py-15">
        <h1 class="text-6xl text-gray-600">Create Post</h1>
    </div>
</div>
...
<div class="w-4/5 m-auto pt-20">
    <form action="/blog" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="uppercase mt-15 bg-blue-500 text-gray-100 txt-lg font-bold py-4 px-8 rounded-3xl">Submit Post</button>
    </form>
</div>
